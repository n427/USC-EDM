  ...
  const renderPost = ({ item }: { item: Post }) => {
    ...
    return (
      <View style={styles.postContainer}>
        <TouchableOpacity onPress={() => router.push(`/profile/${item.username.replace('@', '').toLowerCase()}`)} style={styles.userRow}>
        ...
        {item.eventName && (
          <View style={styles.eventTag}>
            <Text style={styles.eventTagText}>{item.eventName}</Text>
          </View>
        )}
